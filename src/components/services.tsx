...
const services = [
  {
    ...
    icon: "🏨",
    name: "Site Vitrine",
    desc: "Site professionnel pour hôtels et PME françaises. Réservation directe intégrée, SEO technique, responsive mobile. Réduit vos commissions Booking.",
    price: "1 500€",
    priceTo: "– 2 500€",
    features: [
      "Livré en 10-15 jours",
      "Moteur de réservation direct",
  ...
  },
  {
    ...
    desc: "SaaS, dashboards, outils internes. Stack moderne Next.js + FastAPI + PostgreSQL. Architecture scalable dès le départ.",
    price: "Sur devis",
    priceTo: "",
    features: [
      "Next.js 15 + FastAPI",
  ...
  },
  {
    ...
    desc: "Apps iOS & Android avec React Native. Un seul codebase, deux plateformes. Intégration Mobile Money, WhatsApp, paiements.",
    price: "Sur devis",
    priceTo: "",
    features: [
