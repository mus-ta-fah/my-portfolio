  ...
  items: [
    {
      ...
      desc: "Site vitrine premium pour hôtel de charme sur la Petite Côte sénégalaise. Design immersif, galerie plein écran, réservation directe, mobile-first. Livré en 15 jours.",
      stack: "Next.js · Tailwind CSS · Framer Motion · Vercel",
      href: "https://lekenkeni.vercel.app",
    ...
    },
    {
      ...
      desc: "Site de réservation directe pour hôtel indépendant lyonnais. SEO local optimisé, moteur de réservation intégré, design élégant adapté à une clientèle française exigeante.",
      stack: "Next.js · Tailwind CSS · Framer Motion · Vercel",
      href: "https://hotelduparc-lyon.vercel.app",
      linkLabel: "Voir la démo →",
      status: "live",
    },
    {
